...
EOD;
    ...
    public function generate()
    {
        ...
        $files[] = new CodeFile(
            $modulePath . '/controllers/http/DefaultController.php',
            $this->render("controller.php")
        );
        $files[] = new CodeFile(
            $modulePath . '/controllers/console/ConsoleController.php',
            $this->render("xcontroller.php")
        );
        $files[] = new CodeFile(
     ...
     */
    public function getControllerNamespace($id='http')
    {
        return $this->moduleID . "\controllers\\".$id;
    }
}
